...
client.on('message', async message => {
  ...
  fetch(Link).then(() => {
    ...
    **✅ Yazdığınız Proje Başarıyla Uptime Sistemimize Eklendi.**
    `)
    .addField('```m.linkler```','Komutunu Kullanarak Ekledigin Linkleri Görebilirsin!')//yDarKDayS
    .setTimestamp()
...
`)
  .addField('------------------------------------------------------',`
[Destek Sunucu](https://discord.gg/X2fwnsuvEn)
[Botu Davet Et](https://discord.com/api/oauth2/authorize?client_id=722046670400913438&permissions=8&scope=bot)`)
 ...
 [Destek Sunucu](https://discord.gg/X2fwnsuvEn)`).setThumbnail(message.author.avatarURL))
    }
